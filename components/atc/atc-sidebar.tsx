...
import { LayoutDashboard, Users, BookOpen, Award, Menu, X, LogOut } from "lucide-react"

export function ATCSidebar() {
  ...
  return (
    <>
      ...
      <div className="md:hidden flex items-center p-4 border-b">
        ...
        <span className="ml-2 text-lg font-semibold">ATC Panel</span>
      </div>
      ...
      >
        <div className="p-4 border-b">
          <h2 className="text-xl font-bold">ATC Panel</h2>
        </div>
